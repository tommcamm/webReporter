package edu.tomm.webreporter.service.criteria;
...
/**
 * Criteria class for the {@link edu.tomm.webreporter.domain.Report} entity. This class is used
 * in {@link edu.tomm.webreporter.web.rest.ReportResource} to receive all the possible filtering options from
...
public class ReportCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, description, ipAddress, userId, distinct);
    }
